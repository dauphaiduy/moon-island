...
export class PreloadScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    // sprite_farming: 4 cols × 4 rows, each frame 32×32
    // row 0=hoe  row 1=water  row 2=plant  row 3=fishing
    this.load.spritesheet(TextureKey.PlayerFarmingRight, 'assets/right_sprite_farming.png', {
      frameWidth:  32,
      frameHeight: 32,
    });
    this.load.spritesheet(TextureKey.PlayerFarmingLeft, 'assets/left_sprite_farming.png', {
      frameWidth:  32,
      frameHeight: 32,
    });
